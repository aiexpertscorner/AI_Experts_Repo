...
export const FOOTER_LINKS: Record<string, { label: string; href: string }[]> = {
  "AI Tools": [
    ...
    { label: "Freemium AI Tools",   href: "/tools/pricing/freemium" },
    { label: "AI Agents",           href: "/tools/category/ai-agents" },
    { label: "AI Writing Tools",    href: "/tools/category/writing-and-content" },
    { label: "AI Image Generators", href: "/tools/category/image-generation" },
    { label: "AI Coding Tools",     href: "/tools/category/coding-and-dev" },
